...
const credentials = new AWS.SharedIniFileCredentials({ profile: 'auto-publicist' })
...
uploadDirectoryToBucket({ directory: path.join(__dirname, '../dist'), Bucket: 'auto-publicist' }).then(() => {
